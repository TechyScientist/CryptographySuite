...
<div id="body">
    ...
    <h2>About ASCII String Simplified DES</h2>

    <h2>Encode or Decode a Message</h2>
    <form action="" method="post">
        <label for="key">Binary 10-bit Key:</label>
        ...
        <input type="submit" name="ascii-sdes-submit" id="ascii-sdes-submit" value="Encipher/Decipher"/>
    </form>
</div>
